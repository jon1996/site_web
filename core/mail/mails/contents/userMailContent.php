          ...
          <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                    <td height="70">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="h1" style="padding: 5px 0 0 0; text-align: center;">CJX - WEBSITE CONTACT PORTAL</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
            ...
            <tr>
              <td class="innerpadding borderbottom">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="h2">Dear CJX Administrators</td>
                  </tr>
                  <tr>
                    <td class="bodycopy">
                      You have received a new contact request from the website. See below the details:<br><br>

                      <span><span style="color: black;">Name: </span> <span style="color: #55585c;">{name}</span></span><br>
                      <span><span style="color: black;">Email: </span> <span style="color: #55585c;">{email}</span></span><br>
                      <span><span style="color: black;">Phone: </span> <span style="color: #55585c;">{phone}</span></span><br>
                      <span><span style="color: black;">Message:</span><span style="color: #55585c;"> {message}</span></span><br><br>
              ...
              <td class="footer" bgcolor="#2075bc">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    Copyright &copy; 2021
                      <a href="#" class="unsubscribe"><font color="#ffffff"><strong>CONGO JIA XIN - WEBSITE CONTACT PORTAL</strong></font></a>
                    </td>
                  </tr>
